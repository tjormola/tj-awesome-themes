-- Orion theme for Awesome 3.5
-- Copyright (C) 2012-2016 Tuomas Jormola <tj@solitudo.net>
--
-- Licensed under the terms of GNU General Public License Version 2.0.
--
-- Designed to be used with Orion GTK+ theme available at
